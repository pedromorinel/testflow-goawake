class managementObjects {
    ...
    navBar () {
        this.selectors = {
            ...
            expandBar: 'body > app-root > app-dashboard-layout > div > div.dashboard--content > mat-drawer-container > mat-drawer > div > app-sidebar > div > mat-nav-list > app-menu-list-item.ng-tns-c18-7.ng-star-inserted > a > div',
            ...
            driverScreen: 'body > app-root > app-dashboard-layout > div > div.dashboard--content > mat-drawer-container > mat-drawer > div > app-sidebar > div > mat-nav-list > app-menu-list-item.ng-tns-c18-7.ng-star-inserted > div > app-menu-list-item.ng-tns-c18-15.ng-tns-c18-7.ng-star-inserted > a > div'
        }
